...
export const CreateInvoicesForm = () => {
  ...
  return (
    <main className="bg-white p-5 rounded-lg border shadow-md">
      {userMessage && (
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-row gap-5">
          ...
          <div className="mt-8">
            <div className="border rounded-lg p-4 bg-gray-50 w-56">
            ...
            <div className="flex md:flex-row flex-col md:items-start items-end md:gap-4 gap-0 mt-5">
        ...
        <div className="flex justify-end">
          <button
            ...
            disabled={loading}
          >
            {loading ? "Submitting..." : "Submit and print"}
          </button>
        </div>
      </form>
      <Modal
