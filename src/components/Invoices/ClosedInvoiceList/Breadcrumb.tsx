  ...
  return (
    <>
      <main className="pb-4 border-b flex justify-between items-center">
        <div>
          <p className="text-[16px] font-[600]">Closed Invoices List</p>
          <div className="sm:block hidden">
            <div className="flex items-center">
              ...
              <p className="text-[12px] text-[#797c8b]">Invoices</p>
              <FaAngleRight className="text-[12px] text-[#797c8b] mx-2" />
              <p className="text-[12px] text-[#797c8b]">Closed Invoices List</p>
            </div>
          </div>
        </div>
        <Link
