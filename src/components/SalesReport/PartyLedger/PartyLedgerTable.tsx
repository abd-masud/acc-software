...
import { PartyLedgerReportButton } from "./PartyLedgerReport";
import { Customers } from "@/types/customers";
import { useAuth } from "@/contexts/AuthContext";

export const PartyLedgerTable: React.FC<InvoicesTableProps> = ({
  invoices,
  loading,
}) => {
  const { user } = useAuth();
        ...
        <div className="sm:flex gap-2">
          ...
          {customerSelected && (
            <div className="flex items-center justify-end gap-2">
              ...
              />
              <PartyLedgerReportButton invoices={filteredInvoices} />
            </div>
          )}
        </div>
      </div>
